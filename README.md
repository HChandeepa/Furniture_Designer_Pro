...
|--------------|---------------|------------------|
| ![Login]([("./assets/Screenshots/login.png") | ![Signup](https://via.placeholder.com/300x200?text=Signup+Screen) | ![Products](https://via.placeholder.com/300x200?text=Product+Catalog) |
