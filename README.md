...
|--------------|---------------|------------------|
| ![Login]([("https://github.com/HChandeepa/Furniture_Designer_Pro/blob/main/furni%203d/assets/Screenshots/login.png") | ![Signup](https://via.placeholder.com/300x200?text=Signup+Screen) | ![Products](https://via.placeholder.com/300x200?text=Product+Catalog) |
